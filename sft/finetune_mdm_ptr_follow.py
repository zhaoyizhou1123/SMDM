...
def setup(
    ...
    wandb_logger = WandbLogger(name=hp_name, save_dir=out_dir, project='ptr_follow_sft')
...
def main(fabric, pretrain_path, resume):
    ...
    train_set = preprocess_ptr_follow(tokenizer, max_prompt_length=256, max_response_length=16)
