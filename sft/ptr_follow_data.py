...
def preprocess_ptr_follow(tokenizer, max_prompt_length=256, max_response_length=16, order='reverse'):
    train_dataset = []
...
def preprocess_ptr_follow_ar_split(tokenizer, max_prompt_length=256, max_response_length=16, r2l=False, order='reverse', num_val=1000):
    '''
    support different order.
    Pad token id is 1.
    '''
